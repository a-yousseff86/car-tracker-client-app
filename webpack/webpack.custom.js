...
module.exports = async (config, options, targetOptions) => {
  ...
  const patterns = [
    ...
    // devops-needle-add-assets-to-webpack - JHipster will add/remove third-party resources in this array
  ];
  ...
  config.plugins.push(
    new webpack.DefinePlugin({
      ...
      // (see the `devops.cors` common JHipster property in the `application-*.yml` configurations)
